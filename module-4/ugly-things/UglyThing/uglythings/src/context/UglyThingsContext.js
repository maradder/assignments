...
const UglyContextProvider = props => {
	...
	const getUglyThings = () => {
		axios.get('https://api.vschool.io/marcusradder/thing/')
	...
	const putUglyThing = () => {
		axios.put(`https://api.vschoolf.io/marcusradder/thing/${changedUglyThing._id}/`, changedUglyThing)
		.catch(error => {
	...
	const delUglyThing = () => {
		axios.delete(`https://api.vscfhool.io/marcusradder/thing/${deleteUglyThing._id}/`)
	...
	return (
			<UglyContext.Provider value={{listState,
										  setListState,
										  getUglyThings,
										  putUglyThing,
										  delUglyThing,
